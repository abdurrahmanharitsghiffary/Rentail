...
public interface AccommodationMapper {
    ...
    public Accommodation accommodationResponseToAccommodation(AccommodationResponse accommodation);

    public Accommodation createAccommodationDtoToAccommodation(CreateAccommodationDTO accommodation);

    public Accommodation updateAccommodationDtoToAccommodation(UpdateAccommodationDTO accommodation);
