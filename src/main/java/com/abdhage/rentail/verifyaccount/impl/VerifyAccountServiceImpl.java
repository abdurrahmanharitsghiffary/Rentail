package com.abdhage.rentail.verifyaccount.impl;
...
import com.abdhage.rentail.verifyaccount.VerifyAccountService;
...
public class VerifyAccountServiceImpl implements VerifyAccountService {
    ...
    public void requestVerifyAccount(String email) {
        userRepository.findByEmail(email).ifPresent(user -> {
            ...
            mailService
                    .sendMail(new EmailDetailsDTO("Verify Account", "Visit here to verify your account: http://localhost:8080/api/v1/auth/verify-account/" + token.getToken(), email));
