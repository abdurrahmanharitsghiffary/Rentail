...
import com.abdhage.rentail.verifyaccount.dto.RequestVerifyAccountDTO;
...
public class VerifyAccountController {
    ...
    public ApiResponse<?> requestVerifyAccount(@Valid @RequestBody RequestVerifyAccountDTO dto) {
        ...
        return new ApiResponse<>(null, HttpStatus.OK.value(), "If your email is valid, correct, and are not verified, link to verify your account will be sent to your email");
    }
